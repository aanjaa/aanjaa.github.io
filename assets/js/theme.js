...
// On first visit, fall back to the user's OS preference so the initial render still
// respects their system setting; after that the value is persisted in localStorage.
